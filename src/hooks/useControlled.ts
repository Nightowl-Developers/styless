...
export interface UseControlledProps<ValueType = unknown> {
...
export default function useControlled<ValueType = any>({
    controlled,
    default: defaultProp,
    name,
    state = 'value'
}: UseControlledProps<ValueType>): [ValueType, React.Dispatch<ValueType>] {
